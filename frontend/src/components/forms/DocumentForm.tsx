...
const DocumentForm: React.FC<DocumentFormProps> = ({
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      const dropdownButton = document.querySelector(
        'button[aria-controls="category-dropdown"]'
      );
  ...
  const handleFormSubmit = async (
    data: Omit<DocumentCreateData, "content" | "tags" | "organization">,
    ...
    if (
      ...
      console.log(
        "Preventing accidental form submission from editor interaction"
      );
      return;
    }
    ...
    <div className="space-y-6">
          ...
          <div className="relative w-full">
            ...
            <div className="relative">
              ...
              >
                ...
                <svg
                  className="ml-auto h-4 w-4 fill-current text-gray-700 dark:text-primary-300"
      ...
      {initialData && (
        <div className="flex items-center">
          ...
          />
          <label
            htmlFor="create_new_version"
            className="ml-2 block text-sm text-primary-700 dark:text-primary-300"
          >
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-primary-600">
                        You are about to leave this page to manage categories.
